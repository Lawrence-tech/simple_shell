...
/**
  ...
  *@info: Structure containing args used to maintain const () prototype.
  *Return: always success, so long as argv[] is not 'exit'
  */
...
/**
  *_myhelp - change the current dir of process
  *@info: Structure containing args used to maintain const () prototype.
  *Return: 0, success.
  */
